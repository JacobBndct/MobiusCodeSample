...
using SleepHerd.Cutscenes;

namespace SleepHerd.Core.CustomSceneManager
{
	[CreateAssetMenu(fileName = "Cutscene", menuName = "Scene Transitions/Cutscene")]
	public class FadeIntoCutsceneTransitionScriptableObject : AbstractSceneTransitionScriptableObject
	{
